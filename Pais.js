...
export default function Pais({ navigation }) {
  const handleCountrySelection = (Pais) => {
    navigation.navigate('Produto', { Pais });
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity
          style={styles.button}
          onPress={() => handleCountrySelection('Brasil')}>
          <Text style={styles.buttonText}>Brasil</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.button}
          onPress={() => handleCountrySelection('Chile')}>
          <Text style={styles.buttonText}>Chile</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.button}
          onPress={() => handleCountrySelection('Argentina')}>
          <Text style={styles.buttonText}>Argentina</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.button}
          onPress={() => handleCountrySelection('Uruguai')}>
